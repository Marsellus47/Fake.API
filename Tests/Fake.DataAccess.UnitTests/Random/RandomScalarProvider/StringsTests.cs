...
{
    public class StringsTests : RandomScalarProviderTestsBase
    {
        [Fact]
        ...
        [Fact]
        public void ShouldReturnEmptyEnumerationForInvertedMinMaxLength()
        {
            // Arrange
        ...
        [Fact]
        public void ShouldReturnEmptyEnumerationForInvertedMinMaxChar()
        {
            // Arrange
        ...
        [Fact]
        public void ShouldReturnEmptyEnumerationForNegativeMinLength()
        {
            // Arrange
