...
namespace Fake.API.IntegrationTests.GraphQL.Random
{
    ...
    {
        public EvensTests(IdentityServerAuthenticationHostFixture hostFixture)
            : base(hostFixture) { }
        ...
        {
            // Arrange
            string query = "query { random { evens } }";
...
query myQuery($count:Int!, $minValue:Int) {
  random {
    evens(count:$count, min:$minValue)
  }
}",
                OperationName = "myQuery",
                Variables = new
...
query myQuery($count:Int!, $maxValue:Int) {
  random {
    evens(count:$count, max:$maxValue)
  }
}",
                OperationName = "myQuery",
                Variables = new
...
query myQuery($count:Int!, $minValue:Int, $maxValue:Int) {
  random {
    evens(count:$count, min:$minValue, max:$maxValue)
  }
}",
                OperationName = "myQuery",
                Variables = new
